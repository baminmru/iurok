...
function DefineInterface_iu_urok_video_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_videoedit');
...
function DefineForms_iu_urok_video_edit(){

var BreakUpload=false;
Ext.define('Form_iu_urok_videoedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_videoedit',
...
Ext.define('EditWindow_iu_urok_videoedit', {
