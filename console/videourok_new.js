    ...
    VU_Page = Ext.create('Ext.form.Panel', 
	{
				...
				[
					{
						...
						height:400,
						itemId:'mediaplayer',
						html:'<video id="video_1" class="video-js vjs-default-skin" controls preload="auto" width="640" height="400" data-setup="{}" > <source src="/video/urok.480.mp4" type="video/mp4" /></video>',
						
					listeners:{
							render:function(){
								//myPlayer=videojs('video_1');
								
								myPlayer=document.getElementById("video_1");
								//myPlayer.ontimeupdate=OnTime;
								myPlayer.onpause=UpdatePlayBtn;
								myPlayer.onplay=UpdatePlayBtn;
								myPlayer.volume=0.5;
								PlayVideo();
								
								intervalID = window.setInterval(OnTime, 1000);
		...
		listeners:{
			...
			close:function( panel, eOpts ){
				...
				myPlayer.onplay=null;
				myPlayer.onpause=null;
				//myPlayer.ontimeupdate=null;
