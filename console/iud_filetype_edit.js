...
function DefineInterface_iud_filetype_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iud_ft.edit')!=0){
                var edit = Ext.create('EditWindow_iud_filetypeedit');
...
function DefineForms_iud_filetype_edit(){


Ext.define('Form_iud_filetypeedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iud_filetypeedit',
...
Ext.define('EditWindow_iud_filetypeedit', {
