...
function DefineInterface_iu_statustask_(id,mystore){
...
var grid_iu_state_tasklink;
    ...
    function ChildOnAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_state_tasklink');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_statustask');
...
function DefineForms_iu_statustask_(){


Ext.define('Form_iu_statustask', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statustask',
...
Ext.define('EditWindow_iu_statustask', {
    ...
    title:  'Задачи',
    items:[{
        xtype:  'f_iu_statustask'
	}]
	});

Ext.define('Form_iu_state_tasklink', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_state_tasklink',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_state_tasklink', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
