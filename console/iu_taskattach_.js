...
function DefineInterface_iu_taskattach_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskattach');
...
function DefineForms_iu_taskattach_(){


Ext.define('Form_iu_taskattach', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskattach',
...
Ext.define('EditWindow_iu_taskattach', {
