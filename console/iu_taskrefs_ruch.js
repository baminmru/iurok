...
function DefineInterface_iu_taskrefs_ruch(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskrefsruch');
...
function DefineForms_iu_taskrefs_ruch(){


Ext.define('Form_iu_taskrefsruch', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskrefsruch',
...
Ext.define('EditWindow_iu_taskrefsruch', {
