...
function DefineInterface_iu_taskattach_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskattach_edit');
...
function DefineForms_iu_taskattach_edit(){


Ext.define('Form_iu_taskattach_edit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskattach_edit',
...
Ext.define('EditWindow_iu_taskattach_edit', {
