...
function DefineInterface_iu_statustask_edit(id,mystore){
...
var grid_iu_state_tasklink;
    ...
    if( grid_iu_state_tasklink.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
    ...
    if( grid_iu_state_tasklink.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_state_tasklinkedit');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_statustaskedit');
...
,
    ...
    listeners: {
        resize: function ( tree, width, height, oldWidth, oldHeight, eOpts ){
        		grid_iu_state_tasklink.setHeight( height * 0.5 );
        },
...
function DefineForms_iu_statustask_edit(){


Ext.define('Form_iu_statustaskedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statustaskedit',
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('contoller', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
store: cmbstore_iu_crole,
valueField:     'brief',
displayField:   'brief',
typeAhead: true,
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('statusonclose', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
select: function ( combo, records, eOpts ) {  
        ...
        combo.up('form' ).activeRecord.set('possiblestatuses', ids   );}  
...
Ext.define('EditWindow_iu_statustaskedit', {
    ...
    title:  'Задачи',
    items:[{
        xtype:  'f_iu_statustaskedit'
	}]
	});

Ext.define('Form_iu_state_tasklinkedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_state_tasklinkedit',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_state_tasklinkedit', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
