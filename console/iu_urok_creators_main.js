...
function DefineInterface_iu_urok_creators_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_creatorsmain');
...
function DefineForms_iu_urok_creators_main(){


Ext.define('Form_iu_urok_creatorsmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_creatorsmain',
...
Ext.define('EditWindow_iu_urok_creatorsmain', {
