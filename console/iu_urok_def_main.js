...
function DefineInterface_iu_urok_def_main(id,mystore,selection){
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('subject', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('theteacher', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
function DefineForms_iu_urok_def_main(){


Ext.define('Form_iu_urok_defmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_defmain',
...
Ext.define('EditWindow_iu_urok_defmain', {
