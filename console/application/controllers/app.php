...
class App extends CI_Controller
{
	...
	*/
	...
	function getTeachers() {
        log_message('debug', 'getTeachers ');
          
        $res = $this->jservice->get(array('Action' => 'getTeachers'));
        if (empty($res)) {
            return array('success' => FALSE, 'msg' => 'No data found');
        } else {
	...
	function getSubjectsArch() {
        log_message('debug', 'getSubjects ');
          
        $res = $this->jservice->get(array('Action' => 'getSubjectsArch'));
        if (empty($res)) {
            return array('success' => FALSE, 'msg' => 'No data found');
        } else {
	...
	function getTeachersArch() {
        log_message('debug', 'getTeachers ');
          
        $res = $this->jservice->get(array('Action' => 'getTeachersArch'));
        if (empty($res)) {
            return array('success' => FALSE, 'msg' => 'No data found');
        } else {
	...
	function getGANTT() {
			...
			$iu_urok_gantt= $this->jservice->get(array('Action' => 'GetGANTT', 'DocumentID'=>$this->input->get_post('id', TRUE)));
			$return = array(
				'data'    => $iu_urok_gantt
			);
			print json_encode($return);
