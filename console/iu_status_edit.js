...
function DefineInterface_iu_status_edit(id,mystore,selection){
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('theprocess', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
onTrigger1Click : function(){
		this.collapse();
		this.clearValue();
		this.up('form' ).activeRecord.set('thestage',null );
},
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('thestage', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
function DefineForms_iu_status_edit(){


Ext.define('Form_iu_statusedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statusedit',
...
Ext.define('EditWindow_iu_statusedit', {
