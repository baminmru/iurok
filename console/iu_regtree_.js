...
function DefineInterface_iu_regtree_(id,treestore_iu_regtree){
...
var grid_iu_regdocs;
    ...
    if( grid_iu_regdocs.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('iu_reg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_regdocs');
...
var p1;
    ...
    function onDeleteClick(){
     ...
     function onAddRootClick(){
   	if(CheckOperation('iu_reg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_regtree');
...
function DefineForms_iu_regtree_(){


Ext.define('Form_iu_regtree', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_regtree',
...
Ext.define('EditWindow_iu_regtree', {
...
Ext.define('Form_iu_regdocs', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_regdocs',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_regdocs', {
    extend:  'Ext.window.Window',
    maxHeight: 497,
    maxWidth: 900,
    autoScroll:true,
