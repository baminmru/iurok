...
function DefineInterface_iu_statusnext_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_statusnext');
...
function DefineForms_iu_statusnext_(){


Ext.define('Form_iu_statusnext', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statusnext',
...
Ext.define('EditWindow_iu_statusnext', {
    ...
    items:[{
        xtype:  'f_iu_statusnext'
	}]
	});

Ext.define('Form_iu_statuschanger', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statuschanger',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_statuschanger', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
