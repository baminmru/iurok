...
function DefineInterface_iu_orgtree_edit(id,treestore_iu_orgtree){
...
var grid_iu_orgusr;
    ...
    if( grid_iu_orgusr.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('iu_org.edit')!=0){
                var edit = Ext.create('EditWindow_iu_orgusredit');
...
var p1;
    ...
    function onDeleteClick(){
     ...
     function onAddRootClick(){
   	if(CheckOperation('iu_org.edit')!=0){
                var edit = Ext.create('EditWindow_iu_orgtreeedit');
...
function DefineForms_iu_orgtree_edit(){


Ext.define('Form_iu_orgtreeedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_orgtreeedit',
...
Ext.define('EditWindow_iu_orgtreeedit', {
    ...
    title:  'Орг структура',
    items:[{
        xtype:  'f_iu_orgtreeedit'
	}]
	});

Ext.define('Form_iu_orgusredit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_orgusredit',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('orguser', records[0].get('id'));} ,focus: function()   {  this.store.load();  } },
...
Ext.define('EditWindow_iu_orgusredit', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
