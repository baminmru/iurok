...
function DefineInterface_iu_urok_creators_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_creatorsedit');
...
function DefineForms_iu_urok_creators_edit(){


Ext.define('Form_iu_urok_creatorsedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_creatorsedit',
...
Ext.define('EditWindow_iu_urok_creatorsedit', {
