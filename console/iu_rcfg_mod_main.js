...
function DefineInterface_iu_rcfg_mod_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_modmain');
...
function DefineForms_iu_rcfg_mod_main(){


Ext.define('Form_iu_rcfg_modmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_modmain',
...
Ext.define('EditWindow_iu_rcfg_modmain', {
