...
function DefineInterface_iu_orgtree_(id,treestore_iu_orgtree){
...
var grid_iu_orgusr;
    ...
    if( grid_iu_orgusr.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('iu_org.edit')!=0){
                var edit = Ext.create('EditWindow_iu_orgusr');
...
var p1;
    ...
    function onDeleteClick(){
     ...
     function onAddRootClick(){
   	if(CheckOperation('iu_org.edit')!=0){
                var edit = Ext.create('EditWindow_iu_orgtree');
...
function DefineForms_iu_orgtree_(){


Ext.define('Form_iu_orgtree', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_orgtree',
...
Ext.define('EditWindow_iu_orgtree', {
...
Ext.define('Form_iu_orgusr', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_orgusr',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_orgusr', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
