...
function DefineInterface_iu_taskvideo_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskvideo');
...
function DefineForms_iu_taskvideo_(){

var BreakUpload=false;
Ext.define('Form_iu_taskvideo', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskvideo',
...
Ext.define('EditWindow_iu_taskvideo', {
