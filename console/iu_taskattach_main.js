...
function DefineInterface_iu_taskattach_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskattachmain');
...
function DefineForms_iu_taskattach_main(){


Ext.define('Form_iu_taskattachmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskattachmain',
...
Ext.define('EditWindow_iu_taskattachmain', {
