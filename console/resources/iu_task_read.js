...
function DefineInterface_iu_task_read(id,mystore,selection){
...
queryMode:      'local',
emptyText:      '',
name:   'isdelegated_grid',
itemId:   'isdelegated_grid',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('isdelegated', records[0].get('value'));}  },
...
function DefineForms_iu_task_read(){


Ext.define('Form_iu_taskread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskread',
...
Ext.define('EditWindow_iu_taskread', {
