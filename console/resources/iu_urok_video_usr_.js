...
function DefineInterface_iu_urok_video_usr_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_videousr_');
...
function DefineForms_iu_urok_video_usr_(){

var BreakUpload=false;
Ext.define('Form_iu_urok_videousr_', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_videousr_',
...
Ext.define('EditWindow_iu_urok_videousr_', {
