...
function DefineInterface_iu_tmcadr_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_tm.edit')!=0){
                var edit = Ext.create('EditWindow_iu_tmcadredit');
...
function DefineForms_iu_tmcadr_edit(){


Ext.define('Form_iu_tmcadredit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_tmcadredit',
...
Ext.define('EditWindow_iu_tmcadredit', {
