...
var groupingFeature_autoiu_us_def = Ext.create('Ext.grid.feature.Grouping',{
groupByText:  'Группировать по этому полю',
showGroupsText:  'Показать группировку'
});
var interval_autoiu_us_def;
Ext.define('grid_autoiu_us_def', {
    extend:  'Ext.grid.Panel',
    alias: 'widget.g_v_autoiu_us_def',
    requires: [
        'Ext.grid.*',
        'Ext.form.field.Text',
    ...
    initComponent: function(){
        Ext.apply(this, {
        frame: false,
        store: store_v_autoiu_us_def,
        features: [groupingFeature_autoiu_us_def],
        ...
        columns: [
            {text: "Этап", width:200, dataIndex: 'iu_us_def_topstage', sortable: true}
            ,
            {text: "Подэтап", width:200, dataIndex: 'iu_us_def_iu_urok_stage', sortable: true}
            ,
            {text: "Завершен", width:200, dataIndex: 'iu_us_def_isdone', sortable: true}
            ,
            {text: "Урок", width:200, dataIndex: 'iu_us_def_theprocess', sortable: true}
        ]
        ,
...
displayField:   'brief',
typeAhead: true,
name:   'iu_us_def_topstage_id',
itemId:   'iu_us_def_topstage_id',
fieldLabel:  '',
emptyText:      'Этап',
hideLabel:  true
}
...
displayField:   'brief',
typeAhead: true,
name:   'iu_us_def_iu_urok_stage_id',
itemId:   'iu_us_def_iu_urok_stage_id',
fieldLabel:  '',
emptyText:      'Подэтап',
hideLabel:  true
}
...
queryMode:      'local',
emptyText:      '',
name:   'iu_us_def_isdone_val',
itemId:   'iu_us_def_isdone_val',
fieldLabel:  '',
emptyText:      'Завершен',
hideLabel:  true,
...
displayField:   'brief',
typeAhead: true,
name:   'iu_us_def_theprocess_id',
itemId:   'iu_us_def_theprocess_id',
fieldLabel:  '',
emptyText:      'Урок',
hideLabel:  true
}
    ...
    listeners: {
        ...
        ,
        	added:function(){
        			//interval_autoiu_us_def= setInterval(function() {  
        			//	store_v_autoiu_us_def.load();
        			//}, 60000);
        		}
        	,
        	destroy:function(){
        		//clearInterval(interval_autoiu_us_def);
        }
    },
    onDeleteConfirm:function(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_v_autoiu_us_def/deleteRow',
            method:  'POST',
    		params: { 
    ...
    onAddClick: function(){
   	    if(CheckOperation('iu_us.edit')!=0 && OTAllowAdd('iu_us')){
            Ext.Ajax.request({
                url: rootURL+'index.php/c_v_autoiu_us_def/newRow',
                method:  'POST',
                params: { 
                },
                ...
                edit.prefix='c_v_autoiu_us_def';
                edit.setTitle('Создание документа:Статус урока') ;
    ...
    onEditClick: function(){
        ...
        if (selection) {
   	    if(CheckOperation('iu_us.edit')!=0 ){
                var edit = Ext.create('iu.windowObjects');
                edit.prefix='c_v_autoiu_us_def';
                edit.setTitle('Редактирование документа: Статус урока') ;
...
function iu_us_Jrnl(){ 
  ...
  var iu_us= Ext.create('Ext.form.Panel', {
      ...
      fieldDefaults: {
        ...
        items: [{
            itemId:'gr_autoiu_us_def',
            xtype:'g_v_autoiu_us_def',
            layout: 'fit',
            flex: 1,
            store: store_v_autoiu_us_def
    }] // tabpanel
