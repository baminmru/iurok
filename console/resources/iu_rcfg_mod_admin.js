...
function DefineInterface_iu_rcfg_mod_admin(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_modadmin');
...
function DefineForms_iu_rcfg_mod_admin(){


Ext.define('Form_iu_rcfg_modadmin', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_modadmin',
...
Ext.define('EditWindow_iu_rcfg_modadmin', {
