...
function DefineInterface_iu_urok_docs_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_docsread');
...
function DefineForms_iu_urok_docs_read(){


Ext.define('Form_iu_urok_docsread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_docsread',
...
Ext.define('EditWindow_iu_urok_docsread', {
