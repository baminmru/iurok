 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_us.edit')!=0){
                ...
                p1.store.insert(0, new model_iu_urok_msg());
 ...
 p1=   new Ext.grid.Panel(
      ...
      stateful:stateFulSystem,
       stateId:  'iu_urok_msg',
        ...
        frame: true,
        instanceid: '',
        features: [groupingFeature_iu_urok_msg,filterFeature_iu_urok_msg],
          dockedItems: [{
                xtype:  'toolbar',
                items: [
                {
...
{text: "Сообщение", width: 200, dataIndex: 'info', sortable: true}
            ,
{text: "Дата сообщения", width:110, dataIndex: 'thedate', sortable: true, xtype: 'datecolumn',    renderer:myDateRenderer}
        ]
       ,
    listeners: {
...
function DefineForms_iu_urok_msg_(){
