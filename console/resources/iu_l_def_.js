...
function DefineInterface_iu_l_def_(id,mystore,selection){
...
var p1_valid=false;
     function onSave(close_after_save,callaftersave){
		...
		if(active.get('sender')==CurrentUserID() ){
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
        		...
        		Ext.MessageBox.show({
                title:  'Ошибка',
                msg:    'Нельзя изменять входящтие сообщения!',
                buttons: Ext.MessageBox.OK,
                icon:   Ext.MessageBox.ERROR
        		});
        }
...
function DefineForms_iu_l_def_(){


Ext.define('Form_iu_l_def', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_l_def',
...
Ext.define('EditWindow_iu_l_def', {
