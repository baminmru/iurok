...
Workbook = Ext.extend(Object, {
  ...
  constructor: function(config) {
    ...
    Ext.apply(this, config, {
       ...
       * @property styles
       * @type Array
       * The array of Style objects attached to this workbook
       */
      styles: [],
       ...
       * @type Array
       * Array of all rendered Style objects for this workbook
       */
      compiledStyles: [],
  ...
  addWorksheet: function(store, config) {
    var worksheet = new Worksheet(store, config);
  ...
  /**
   * Adds a new Style to this Workbook
