...
function DefineInterface_iu_taskattach_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskattachread');
...
function DefineForms_iu_taskattach_read(){


Ext.define('Form_iu_taskattachread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskattachread',
...
Ext.define('EditWindow_iu_taskattachread', {
