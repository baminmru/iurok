...
function DefineInterface_iu_urok_def_new_(id,mystore,selection){
...
onTrigger1Click : function(){
		this.collapse();
		this.clearValue();
		this.up('form' ).activeRecord.set('theclassnum',null );
},
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('theteacher', records[0].get('id'));} ,
...
focus: function(combo,record)   {  this.store.load({params:{subject:combo.up('form' ).activeRecord.get('subject_grid'),metodist:-1}});  } },
...
enableRegEx: true,
queryMode:'local',
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('methodist2', records[0].get('id'));} ,
focus: function(combo,record)   {  this.store.load({params:{subject:combo.up('form' ).activeRecord.get('subject_grid'),metodist:-1}});  } },
store: cmbstore_metodist_subj,
valueField:     'brief',
displayField:   'brief',
...
function DefineForms_iu_urok_def_new_(){


Ext.define('Form_iu_urok_defnew_', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_defnew_',
...
Ext.define('EditWindow_iu_urok_defnew_', {
