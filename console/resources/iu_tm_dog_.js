...
function DefineInterface_iu_tm_dog_(id,mystore){
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_tm.edit')!=0){
                var edit = Ext.create('EditWindow_iu_tm_dog');
...
tpl:'<a href=\'/output_file.php?ID={dogfile}&ext={dogfile_ext}&origname={dogfile}\' target=\'_blank\'>Файл</a>'}
            ,
...
function DefineForms_iu_tm_dog_(){


Ext.define('Form_iu_tm_dog', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_tm_dog',
...
Ext.define('EditWindow_iu_tm_dog', {
