...
function DefineInterface_iu_taskrefs_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskrefsread');
...
function DefineForms_iu_taskrefs_read(){


Ext.define('Form_iu_taskrefsread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskrefsread',
...
Ext.define('EditWindow_iu_taskrefsread', {
