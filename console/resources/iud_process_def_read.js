...
function DefineInterface_iud_process_def_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iud_process.edit')!=0){
                var edit = Ext.create('EditWindow_iud_process_defread');
...
function DefineForms_iud_process_def_read(){


Ext.define('Form_iud_process_defread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iud_process_defread',
...
Ext.define('EditWindow_iud_process_defread', {
