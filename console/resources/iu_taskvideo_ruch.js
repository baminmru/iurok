...
function DefineInterface_iu_taskvideo_ruch(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskvideo_ruch');
...
function DefineForms_iu_taskvideo_ruch(){

var BreakUpload=false;
Ext.define('Form_iu_taskvideo_ruch', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskvideo_ruch',
...
Ext.define('EditWindow_iu_taskvideo_ruch', {
