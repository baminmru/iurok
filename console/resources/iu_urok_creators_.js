...
function DefineInterface_iu_urok_creators_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_creators');
...
function DefineForms_iu_urok_creators_(){


Ext.define('Form_iu_urok_creators', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_creators',
...
Ext.define('EditWindow_iu_urok_creators', {
