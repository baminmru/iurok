...
function DefineInterface_iud_process_def_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iud_process.edit')!=0){
                var edit = Ext.create('EditWindow_iud_process_def');
...
function DefineForms_iud_process_def_(){


Ext.define('Form_iud_process_def', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iud_process_def',
...
Ext.define('EditWindow_iud_process_def', {
