...
function DefineInterface_iu_rcfg_docmode_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_rcfg.edit')!=0){
                var edit = Ext.create('EditWindow_iu_rcfg_docmodemain');
...
function DefineForms_iu_rcfg_docmode_main(){


Ext.define('Form_iu_rcfg_docmodemain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_rcfg_docmodemain',
...
Ext.define('EditWindow_iu_rcfg_docmodemain', {
