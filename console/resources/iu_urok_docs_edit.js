...
function DefineInterface_iu_urok_docs_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_docsedit');
	...
	function refRenderer(value, metaData, record, row, col, store, gridView) 
{
 ...
 p1=   new Ext.grid.Panel(
        ...
        columns: [
{text: "Документ", width:200, dataIndex: 'doctype_grid', sortable: true, renderer:refRenderer}
            ,
...
function DefineForms_iu_urok_docs_edit(){


Ext.define('Form_iu_urok_docsedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_docsedit',
...
Ext.define('EditWindow_iu_urok_docsedit', {
