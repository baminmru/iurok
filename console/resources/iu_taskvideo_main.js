...
function DefineInterface_iu_taskvideo_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskvideomain');
...
function DefineForms_iu_taskvideo_main(){


Ext.define('Form_iu_taskvideomain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskvideomain',
...
Ext.define('EditWindow_iu_taskvideomain', {
