...
function DefineInterface_iu_statusnext_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_statusnextread');
...
function DefineForms_iu_statusnext_read(){


Ext.define('Form_iu_statusnextread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statusnextread',
...
Ext.define('EditWindow_iu_statusnextread', {
    ...
    items:[{
        xtype:  'f_iu_statusnextread'
	}]
	});

Ext.define('Form_iu_statuschangerread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statuschangerread',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_statuschangerread', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
