...
function DefineInterface_iu_u_def_edit(id,mystore,selection){
...
onTrigger1Click : function(){
		this.collapse();
		this.clearValue();
		this.up('form' ).activeRecord.set('thetown',null );
},
...
function DefineForms_iu_u_def_edit(){


Ext.define('Form_iu_u_defedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_u_defedit',
...
Ext.define('EditWindow_iu_u_defedit', {
