                    ...
                    [
                        {
                            ...
                            handler: function() {
								...
								if(user_input['reportname']){
									...
									if(user_input['curator']==null){
										src=src+'&rcurator='+'';
									}else{
										src=src+'&rcurator='+user_input['curator'].replace('{','').replace('}','');
									}		
									
									if(user_input['theteacher']==null){
										src=src+'&rtheteacher='+'';
									}else{
										src=src+'&rtheteacher='+user_input['theteacher'].replace('{','').replace('}','');
									}		
