...
function DefineInterface_iu_taskrefs_edit(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_t.edit')!=0){
                var edit = Ext.create('EditWindow_iu_taskrefsedit');
...
function DefineForms_iu_taskrefs_edit(){


Ext.define('Form_iu_taskrefsedit', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_taskrefsedit',
...
Ext.define('EditWindow_iu_taskrefsedit', {
