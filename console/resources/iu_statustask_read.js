...
function DefineInterface_iu_statustask_read(id,mystore){
...
var grid_iu_state_tasklink;
    ...
    if( grid_iu_state_tasklink.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_state_tasklinkread');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_s.edit')!=0){
                var edit = Ext.create('EditWindow_iu_statustaskread');
...
function DefineForms_iu_statustask_read(){


Ext.define('Form_iu_statustaskread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statustaskread',
...
Ext.define('EditWindow_iu_statustaskread', {
    ...
    title:  'Задачи',
    items:[{
        xtype:  'f_iu_statustaskread'
	}]
	});

Ext.define('Form_iu_state_tasklinkread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_state_tasklinkread',
initComponent: function(){
    this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_iu_state_tasklinkread', {
    extend:  'Ext.window.Window',
    maxHeight: 227,
    maxWidth: 900,
    autoScroll:true,
