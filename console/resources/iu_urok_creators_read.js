...
function DefineInterface_iu_urok_creators_read(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_creatorsread');
...
function DefineForms_iu_urok_creators_read(){


Ext.define('Form_iu_urok_creatorsread', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_creatorsread',
...
Ext.define('EditWindow_iu_urok_creatorsread', {
