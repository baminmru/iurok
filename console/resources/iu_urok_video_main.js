...
function DefineInterface_iu_urok_video_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_videomain');
...
function DefineForms_iu_urok_video_main(){


Ext.define('Form_iu_urok_videomain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_videomain',
...
Ext.define('EditWindow_iu_urok_videomain', {
