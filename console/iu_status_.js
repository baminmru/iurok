...
function DefineInterface_iu_status_(id,mystore,selection){
...
function DefineForms_iu_status_(){


Ext.define('Form_iu_status', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_status',
...
Ext.define('EditWindow_iu_status', {
