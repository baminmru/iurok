...
function DefineInterface_iu_status_main(id,mystore,selection){
...
editable: false,
listeners:{  select: function ( combo, records, eOpts ) {combo.up('form' ).activeRecord.set('thestage', records[0].get('id'));}  },
...
fieldLabel:  'Это начальный статус',
labelClsExtra:'x-item-mandatory',
allowBlank:false
}
,
...
fieldLabel:  'Это завершающий статус',
labelClsExtra:'x-item-mandatory',
allowBlank:false
}
       ],
...
function DefineForms_iu_status_main(){


Ext.define('Form_iu_statusmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_statusmain',
...
Ext.define('EditWindow_iu_statusmain', {
