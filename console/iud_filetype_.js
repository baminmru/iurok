...
function DefineInterface_iud_filetype_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iud_ft.edit')!=0){
                var edit = Ext.create('EditWindow_iud_filetype');
...
function DefineForms_iud_filetype_(){


Ext.define('Form_iud_filetype', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iud_filetype',
...
Ext.define('EditWindow_iud_filetype', {
