...
function DefineInterface_iu_urok_docs_usr_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('iu_urok.edit')!=0){
                var edit = Ext.create('EditWindow_iu_urok_docsusr_');
...
function DefineForms_iu_urok_docs_usr_(){


Ext.define('Form_iu_urok_docsusr_', {
extend:  'Ext.form.Panel',
alias: 'widget.f_iu_urok_docsusr_',
...
Ext.define('EditWindow_iu_urok_docsusr_', {
